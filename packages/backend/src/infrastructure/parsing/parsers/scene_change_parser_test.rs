...
mod tests {
    ...
    fn test_should_parse_set_source_pattern() {
        ...
        let line =
            "2026/01/11 10:30:45 12345678 abc [INFO Client 1234] [SCENE] Set Source [The Coast]";
    ...
    fn test_should_parse_load_source_pattern() {
        let parser = create_parser();
        let line =
            "2026/01/11 10:30:45 12345678 abc [INFO Client 1234] [SCENE] Load Source [Clearfell]";
        assert!(parser.should_parse(line));
    }
    ...
    fn test_should_parse_returns_false_for_scene_without_pattern() {
        ...
        let line =
            "2026/01/11 10:30:45 12345678 abc [INFO Client 1234] [SCENE] Other Event [SomeZone]";
        assert!(!parser.should_parse(line));
    }
