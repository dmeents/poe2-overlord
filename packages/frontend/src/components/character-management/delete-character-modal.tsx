  ...
  return (
    <div className='fixed inset-0 z-50 overflow-y-auto'>
      <div className='flex min-h-full items-center justify-center p-4'>
        ...
        {/* Modal */}
        <div className='relative w-full max-w-md bg-zinc-800 rounded-lg shadow-xl border border-zinc-700'>
          <div className='p-6'>
            <div className='flex items-center gap-3 mb-4'>
              ...
              <h2 className='text-xl font-bold text-white'>Delete Character</h2>
            </div>
            ...
            <div className='mb-6'>
              ...
              <div className='mt-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg'>
                <p className='text-sm text-red-400'>
                  ...
                  time tracking data and statistics for this character will be
                  permanently deleted.
                </p>
              </div>
            </div>
