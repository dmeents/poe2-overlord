...
export const formSelectStyles = {
  ...
  // Basic select
  basicSelect:
    'w-full h-10 px-3 py-2 pr-8 bg-stone-800/50 border border-stone-600 text-stone-50 text-sm focus:outline-none focus:ring-1 focus:ring-ember-500/50 focus:border-ember-500/50 transition-colors appearance-none cursor-pointer',
  ...
  option: 'bg-stone-800 text-stone-50',

  // Dropdown select
  triggerContainer: 'relative',
  trigger:
    'flex items-center justify-between w-full px-3 py-2 bg-stone-700/30 hover:bg-stone-700/50 border border-stone-700/50 text-stone-300 hover:text-stone-50 transition-colors h-10 focus:outline-none focus:ring-1 focus:ring-ember-500/50 focus:border-ember-500/50 disabled:opacity-50 disabled:cursor-not-allowed',
  triggerText: 'text-sm font-medium truncate',
  triggerIcons: 'flex items-center space-x-2',
  clearButton: 'text-stone-400 hover:text-stone-50 text-lg leading-none px-1 transition-colors',
  chevron: 'w-4 h-4 text-stone-200 transition-transform',
