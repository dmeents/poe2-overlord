export const controlBarClasses = 'flex items-center gap-2 px-3 py-2 border-b border-stone-700/50';
...
export const chipRowClasses = 'px-3 py-2 border-b border-stone-700/50';
