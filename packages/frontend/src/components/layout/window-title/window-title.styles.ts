...
export const windowTitleStyles = {
  ...
  container:
    'px-4 py-1 bg-stone-950/95 backdrop-blur-sm border-b border-stone-800/50 select-none grid grid-cols-[auto_max-content] fixed top-0 left-0 right-0 z-30 shadow-bottom',
